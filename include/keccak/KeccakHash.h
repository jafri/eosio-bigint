...
/**
  ...
  */
inline HashReturn Keccak_HashInitialize(Keccak_HashInstance *hashInstance, unsigned int rate, unsigned int capacity, unsigned int hashbitlen, unsigned char delimitedSuffix);
...
/**
  ...
  * @return SUCCESS if successful, FAIL otherwise.
  */
inline HashReturn Keccak_HashUpdate(Keccak_HashInstance *hashInstance, const BitSequence *data, BitLength databitlen);
...
/**
  ...
  * @return SUCCESS if successful, FAIL otherwise.
  */
inline HashReturn Keccak_HashFinal(Keccak_HashInstance *hashInstance, BitSequence *hashval);
  ...
  * @return SUCCESS if successful, FAIL otherwise.
  */
inline HashReturn Keccak_HashSqueeze(Keccak_HashInstance *hashInstance, BitSequence *data, BitLength databitlen);
